...
# **Your R Journey Ends Here**

## 🥳 **Congratulations on Your Achievement** 🎊

Take a moment to appreciate what you've accomplished today and in the past three (3) days. When you walked into this workshop, R might have seemed like a mysterious programming language spoken only by statisticians in academia. Now, you're leaving with the fundamental skills to write your own R programs, analyze real data, and solve problems that matter to you.

## **What We've Learned Together**

{% include question.html header="From Zero to R Hero" text="

You started with nothing more than curiosity, and now you can:

**Master the Fundamentals**

- Confidently work with variables and understand how R stores and manipulates different types of data
...
- Create and manipulate vectors and lists to organize your data effectively
...
- Load and use powerful packages that extend R's capabilities infinitely
...
- Use `dplyr` to read, explore, and manipulate real-world datasets
- Extract specific information from large datasets with confidence
- Filter and query data with `filter()`, `select()`, and `mutate()` to find exactly what you're looking for
- Create meaningful visualizations using `ggplot2` that tell compelling stories with your data
...
- Continue learning more advanced R concepts with a solid foundation
" %}

{% include question.html header="Live Comments and Reflections" text="

**What surprised you most about R during the duration of the workshop?**

**Which concept clicked for you that seemed difficult at first?**

**What problem do you want to solve first with your new R skills?**
...
📝 Workshop Feedback Form: [bit.ly/crd_rworkshop](bit.ly/crd_rworkshop)
...
2. **Set Up Your Environment:** Ensure R and RStudio are installed on your personal computer
...
1. Join the Community:
      ...
      - Follow R communities on social media (e.g., #rstats on X/Twitter)
      - Join local R meetups or online forums like RStudio Community
      - Connect with other beginners for mutual support

2. Expand Your Toolkit:

      - Learn about additional dplyr and tidyr features
      - Explore additional ggplot2 themes and extensions (ggthemes, patchwork)
      - Try reading data directly from REDCap, Google Sheets, or APIs

3. Build Something Real:

      - Analyze a dataset related to your interests or field of study
      - Create a simple R Markdown report
      - Contribute to a small open-source R project
" %}

{% include question.html header="Long-term Development (Next 3-6 Months)" text="

1. **Specialize:** Choose an area that excites you — biostatistics, epidemiology, bioinformatics, or clinical data science
2. **Take Advanced Courses:** Build on today's foundation with more specialized training in R
...
- [R for Data Science (2nd ed.)](https://r4ds.hadley.nz/) by Hadley Wickham — free online
- [Swirl](https://swirlstats.com/) — learn R interactively inside RStudio
- [RStudio Education](https://education.rstudio.com/) — curated resources for all levels
- Kaggle Learn (especially for data science with R)
" %}
...
- Kaggle (for data science projects with real datasets)
- TidyTuesday (weekly community data challenge on GitHub)
- Posit Cloud (RStudio in your browser — no installation needed)
" %}
...
- **Skills Demonstrated:** Variable manipulation, data type conversion, control structures, function creation, package usage, data analysis with `dplyr`, statistical testing, and data visualization with `ggplot2`
...
... every expert was once a beginner. Every accomplished R programmer once struggled with their first `ggplot2` layer or their first `dplyr` pipeline. The difference between those who succeed in programming and those who don't isn't talent — it's persistence and curiosity.
...
don't let today be the end of your R story — let it be the beginning. We believe in your potential, and we're excited to see what you'll build next.

**Questions? Need help? Don't hesitate to reach out:**

- **Workshop instructor email:** jllcalorio@gmail.com
- **Follow-up Q&A session:** Sometime in 2026, and really, I'm just at the 8th Floor, College of Medicine Bldg.
" %}
...
Now go forth and code! Your **R adventure** starts now. 📊✨


{% capture text %}
*"The best time to plant a tree was 20 years ago. The second best time is now."* - Chinese Proverb

Your R tree has been planted today. With consistent care and attention, it will grow into something amazing.
{% endcapture %}
